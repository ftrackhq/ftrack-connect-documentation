...
#.  Download the plugins from: https://s3-eu-west-1.amazonaws.com/ftrack-deployment/ftrack-connect/plugins/ftrack-connect-nuke-publish-0.5.1.zip
#.  Unzip ftrack-connect-nuke-publish-0.5.1.zip in <connect-plugin-directory>
