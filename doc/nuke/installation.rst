...
#.  Download the plugins from: https://s3-eu-west-1.amazonaws.com/ftrack-deployment/ftrack-connect/plugins/ftrack-connect-nuke-publish-0.4.0.zip
#.  Unzip ftrack-connect-nuke-publish-0.4.0.zip in <connect-plugin-directory>
